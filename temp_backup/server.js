...
// Prefer generic EMAIL_USER/EMAIL_PASS env vars; fall back to FEEDBACK_EMAIL_* for compatibility
const mailUser = process.env.EMAIL_USER || process.env.FEEDBACK_EMAIL_USER;
const mailPass = process.env.EMAIL_PASS || process.env.FEEDBACK_EMAIL_PASS;
...
if (mailUser && mailPass) {
  ...
  console.warn(
    '⚠️ WARNING: Email credentials are not set in the .env file (EMAIL_USER/EMAIL_PASS or FEEDBACK_EMAIL_USER/FEEDBACK_EMAIL_PASS).',
  );
  console.warn(
